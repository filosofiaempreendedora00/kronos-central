...
const VIEW_IDS = [
  "dashboardView", "agentesView", "kanbanView", "leadsView", "financeiroView", "automacoesView", "chatView", "delfosView",
...
const VIEW_NAV = {
  ...
  kanbanView: "kanban", leadsView: "leads", financeiroView: "financeiro", automacoesView: "automacoes",
...
function navGo(key) {
  ...
  else if (key === "automacoes") Automacoes.open();
...
async function syncNow(btn) {
  ...
  try { if (typeof Automacoes !== "undefined" && Automacoes.render) Automacoes.render(); } catch (_) {}
  closeDrawer();
...
function init() {
  ...
  document.getElementById("autoSyncBtn")?.addEventListener("click", (e) => syncNow(e.currentTarget));
